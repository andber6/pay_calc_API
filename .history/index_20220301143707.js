...
app.post('/post_test_data', (req,res) => {
    ...
    setTimeout(function(){
        ...
        res.send(JSON.stringify({
            stKode: req.body.stKode || null,
            lt: req.body.lt || null,
            krTilleg: req.body.krTilleg || null,
            arslonn: req.body.arslonn || null,
            endringsBelop: req.body.endringsBelop || null,
            changedFieldName: req.body.changedFieldName || null
        }));
